...
function POST()
{
	...
	try {
		...
		if (!array_key_exists($_POST['action'], $GLOBALS['config']['actions']['actions_name'][$ServiceAction->name]) ||
			!array_key_exists($_POST['reaction'], $GLOBALS['config']['reaction']['reactions_name'][$ServiceAction->name]))
